...
import "@/Styles/hooks/ripple.css";

export function useRipple() {
  return useCallback((e: React.PointerEvent<HTMLElement>, target?: HTMLElement, forceCenter = false) => {
    ...
    const release = () => {
      ...
      ripple.addEventListener("animationend", () => {
        ("requestIdleCallback" in window ? requestIdleCallback : setTimeout)(() => wrapper.remove());
      });

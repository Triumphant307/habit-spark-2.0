...
//     (h) => h.isCompleted || h.streak >= h.target,
//   );
...
//                   <span className={styles.CompletedPreview_Emoji}>
//                     {habit.icon}
//                   </span>
//                   <LuCircleCheck
//                     className={styles.CompletedPreview_CheckIcon}
//                   />
//                 </div>

//                 <div className={styles.CompletedPreview_Content}>
//                   <h3 className={styles.CompletedPreview_ItemTitle}>
//                     {habit.title}
//                   </h3>
